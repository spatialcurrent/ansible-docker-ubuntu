# Contributing to ansible-docker-ubuntu

## Contributor License Agreement

Thank you for your interest in contributing.  You will first need to agree to the license.  Simply post the following paragraph, with "your name" and "your github account" substituted as needed, to the first issue [#1](https://github.com/spatialcurrent/ansible-docker-ubuntu/issues/1).  Otherwise, you can email us [here](mailto:opensource@spatialcurrent.io?subject=CLA).
...
See [AUTHORS](https://github.com/spatialcurrent/ansible-docker-ubuntu/blob/master/AUTHORS) for a list of contributors.
